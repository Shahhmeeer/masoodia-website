...
export default function Home() {
  ...
  return (
    <main>
      ...
      <section
        id="services"
        className="mx-auto md:max-w-4xl lg:max-w-6xl xl:max-w-7xl"
      >
        <section>
      ...
      <section className="bg-green-800 text-white flex items-center justify-center min-h-[250px]">
      ...
      <section className="mx-auto md:max-w-5xl lg:max-w-7xl" id="partners">
        <section className="w-full flex items-center justify-center flex-col h-[200px]">
          <h1 className="font-black text-3xl text-green-800 text-center py-8">
      ...
      <section
        ...
        id="contact"
      >
        <section className="mx-auto md:max-w-5xl lg:max-w-7xl text-green-800">
          <h1 className="font-bold text-xl text-center">Get in Touch</h1>
          <p className="my-4 mx-4 text-sm md:mx-0 md:text-base font-semibold">
