...
export default function Footer() {
  ...
  return (
    <footer className="min-h-[500px] flex items-center justify-evenly flex-col relative text-black bg-green-600">
      <section className="mx-auto md:max-w-4xl lg:max-w-6xl xl:max-w-6xl" style={{ width: "100%" }}>
        <div className="flex flex-col md:flex-row mx-8 my-4 md:mx-0 md:my-0">
          <div className="flex-1">
            ...
            <p className="max-w-xs font-medium">Masoodia® is an independent energy company Registered in 2012 and supplying Coal & Bio Mass to many Top Ranking Companies in Pakistan.</p>
          </div>
      ...
      <section className="my-8 w-full text-black bg-white rounded-full flex items-center justify-between max-w-sm md:max-w-4xl lg:max-w-6xl xl:max-w-6xl" style={{ minHeight: "70px" }}>
        <div className="ml-4">
